...
class ImageContainer extends PureComponent {
  ...
  constructor() {
    ...
    this.onTouchEndTime = 0; // 单指触摸开始时间
  ...
  handleTouchStart = (event) => {
    ...
    switch (event.touches.length) {
      case 1: {
        ...
        // console.log('onTouchStartTime', this.onTouchStartTime);
